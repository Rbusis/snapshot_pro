// discovery.js — JTF DISCOVERY v1.6.5 (CLEAN LOG VERSION — API v2 FULL FIX)
// All debug logs removed so we can move to Swing
...
// BTC security (BTC Trend disabled → 0)
...
// ========= START =========
async function main(){
  console.log("🔥 Discovery v1.6.5 démarré (clean logs).");
  await sendTelegram("🟢 Discovery v1.6.5 lancé (clean logs).");
  while(true){
